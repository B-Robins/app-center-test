...
<module external.root.project.path="$MODULE_DIR$/../../../android/app" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: com.microsoft.appcenter:appcenter-analytics:2.4.0@aar" level="project" />
    <orderEntry type="library" name="Gradle: com.microsoft.appcenter.reactnative:appcenter-react-native:2.5.0@aar" level="project" />
    <orderEntry type="library" name="Gradle: com.microsoft.appcenter:appcenter:2.4.0@aar" level="project" />
